...
setup(
    name='unicef-djangosaml2',
    version='0.16.11',
    description='dropin replacement ',
    ...
    author_email="",
    maintainer="",
    url="https://github.com/unicef/djangosaml2",
    download_url="https://pypi.python.org/pypi/unicef-djangosaml2",
    license='Apache 2.0',
